...
public class App 
{
    public static void main( String[] args )
    {
    	...
    	Newyeargift[] g=new Newyeargift[6];
    	g[0]=new Sweet("mysore-pak",100);
    	g[1]=new Sweet("kaju-katli",50);
    	g[2]=new Sweet("jalebi",30);
    	g[3]=new choc("dairy-milk",20);
    	g[4]=new choc("munch",45);
    	g[5]=new choc("kitkat",30);
    	        do {
